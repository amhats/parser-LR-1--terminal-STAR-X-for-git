...
#line 100 "parser_grammar.tab.c" /* yacc.c:339  */
...
union YYSTYPE
{
#line 35 "parser_grammar.y" /* yacc.c:355  */
...
#line 165 "parser_grammar.tab.c" /* yacc.c:355  */
};
...
#line 182 "parser_grammar.tab.c" /* yacc.c:358  */
...
{
     -10,    18,   -10,   -10,   -10,   -10,     5,     5,     0,    29,
     -10,   -10,    -9,   -10,    13,   -10,    -2,    24,   -10,    13,
       5,     5,     5,    14,   -10,    16,    19,   -10,    32,    32,
     -10,   -10,   -10,    14,   -10
};
...
{
       4,     0,     1,    19,    16,    18,     0,     0,     0,     2,
      11,    13,    14,    12,     3,     5,    14,     0,    20,    21,
       0,     0,     0,     0,    22,     0,     9,     8,     7,     6,
      17,    15,    23,     0,    10
};
...
{
     -10,   -10,    -5,   -10,   -10,    -1,     6,   -10,    33
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,     9,    10,    11,    16,    31,    13,    14
};
...
{
      12,    15,    17,   -20,     4,    23,   -20,    18,     3,     4,
       5,     8,    23,     6,     7,    27,    28,    29,     2,    30,
       4,     3,     4,     5,    32,    24,     6,     7,    25,     8,
      20,    21,    22,    33,    26,    20,    21,    22,    20,    34,
       0,    19
};

static const yytype_int8 yycheck[] =
{
       1,     6,     7,    12,     4,    14,    15,     8,     3,     4,
       5,    11,    14,     8,     9,    20,    21,    22,     0,     5,
       4,     3,     4,     5,    25,    12,     8,     9,    15,    11,
       6,     7,     8,    14,    10,     6,     7,     8,     6,    33,
      -1,     8
};
...
{
       0,    18,     0,     3,     4,     5,     8,     9,    11,    19,
      20,    21,    22,    24,    25,    19,    22,    19,    22,    25,
       6,     7,     8,    14,    12,    15,    10,    19,    19,    19,
       5,    23,    22,    14,    23
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 63 "parser_grammar.y" /* yacc.c:1646  */
    {
																	// altarr_data = $2;
...
#line 80 "parser_grammar.y" /* yacc.c:1646  */
    {
																	if(g_coef_type == GMP_MPQ){
																		...
																		if(is_new_var){
																			expandNumVars_AAZ((yyvsp[0].AltArr_t_type), g_num_variables);
																		}	
																		negatePolynomial_AAZ((yyvsp[0].AltArr_t_type));
																		mergeSortPolynomial_AAZ((yyvsp[0].AltArr_t_type));
																		(yyval.AltArr_t_type) = (yyvsp[0].AltArr_t_type);
																	}
...
#line 110 "parser_grammar.y" /* yacc.c:1646  */
    {
																	if(g_coef_type == GMP_MPQ){
																		...
																		if(is_new_var){
																			expandNumVars_AAZ((yyvsp[-2].AltArr_t_type), g_num_variables);
																		}
																		AltArrZ_t *temp_aa_result = makePolynomial_AAZ(DEFAULT_AA_SIZE, g_num_variables);
																		mergeSortPolynomial_AAZ((yyvsp[-2].AltArr_t_type));
																		negatePolynomial_AAZ((yyvsp[0].AltArr_t_type));
																		mergeSortPolynomial_AAZ((yyvsp[0].AltArr_t_type));
																		temp_aa_result = addPolynomials_AAZ((yyvsp[-2].AltArr_t_type), (yyvsp[0].AltArr_t_type), g_num_variables);
																		(yyval.AltArr_t_type) = temp_aa_result;

																		#ifdef PARSER_DEBUG
																			printf_magenta("poly: $1: poly");
																			print_poly_to_terminal_z((yyvsp[-2].AltArr_t_type), g_variables, g_num_variables);
																			printf_magenta("poly: $3: poly");
																			print_poly_to_terminal_z((yyvsp[0].AltArr_t_type), g_variables, g_num_variables);
																			printf_magenta("poly: $$: poly-poly");
																			print_poly_to_terminal_z((yyval.AltArr_t_type), g_variables, g_num_variables);
																		#endif
																		freePolynomial_AAZ((yyvsp[-2].AltArr_t_type));
...
#line 205 "parser_grammar.y" /* yacc.c:1646  */
    {
																	if(g_coef_type == GMP_MPQ){
																		...
																		mergeSortPolynomial_AAZ((yyvsp[-2].AltArr_t_type));
																		mergeSortPolynomial_AAZ((yyvsp[0].AltArr_t_type));
																		temp_aa_result = multiplyPolynomials_AAZ((yyvsp[-2].AltArr_t_type), (yyvsp[0].AltArr_t_type), g_num_variables);
																		(yyval.AltArr_t_type) = temp_aa_result;
...
#line 248 "parser_grammar.y" /* yacc.c:1646  */
    {
																	(yyval.AltArr_t_type) = (yyvsp[-1].AltArr_t_type);
																		...
																		if(g_coef_type == GMP_MPQ)
																			...
																			print_poly_to_terminal_z((yyvsp[-1].AltArr_t_type), g_variables, g_num_variables);
																		printf_magenta("poly: $$: (poly)");
																		if(g_coef_type == GMP_MPQ)
																			print_poly_to_terminal((yyval.AltArr_t_type), g_variables, g_num_variables);
																		else if(g_coef_type == GMP_MPZ)
...
#line 264 "parser_grammar.y" /* yacc.c:1646  */
    {
																	if(g_coef_type == GMP_MPQ){
																		...
																		AltArrZ_t *temp_aa_result = makePolynomial_AAZ(DEFAULT_AA_SIZE, g_num_variables);
																		mergeSortPolynomial_AAZ((yyvsp[-3].AltArr_t_type));
																		temp_aa_result = exponentiatePoly_AAZ((yyvsp[-3].AltArr_t_type), atoi((yyvsp[0].string_type)), g_num_variables);
																		(yyval.AltArr_t_type) = temp_aa_result;

																		#ifdef PARSER_DEBUG
																			printf_magenta("poly: poly^");
																			print_poly_to_terminal_z((yyvsp[-3].AltArr_t_type), g_variables, g_num_variables);
																			printf("NUM: %s\n", (yyvsp[0].string_type));
																			printf_magenta("poly: $$: poly^NUM");
																			print_poly_to_terminal_z((yyval.AltArr_t_type), g_variables, g_num_variables);
																		#endif
...
#line 295 "parser_grammar.y" /* yacc.c:1646  */
    {
																	if(g_coef_type == GMP_MPQ){
																		...
																		#ifdef PARSER_DEBUG
																			printf_magenta("poly: term");
																			print_term_z((yyvsp[0].term_type), g_variables, g_num_variables, "");
																			printf_magenta("poly: $$: term");
																			print_naked_AltArr_t_poly_z((yyval.AltArr_t_type));
																			print_poly_to_terminal_z((yyval.AltArr_t_type), g_variables, g_num_variables);
																		#endif
...
#line 325 "parser_grammar.y" /* yacc.c:1646  */
    {
																	if(g_coef_type == GMP_MPQ){
																		...
																		mpz_t temp_coef;
																		mpz_init(temp_coef);
																		mpz_set_str(temp_coef, (yyvsp[0].string_type), 10);
																		mpz_mul(local_term_z->coef, local_term_z->coef, temp_coef);
																		(yyval.term_type) = local_term_z;
																	}
...
#line 349 "parser_grammar.y" /* yacc.c:1646  */
    {
																	if(g_coef_type == GMP_MPQ){
																		...
																		fill_term_exponent(g_variables, local_term_z->exp, (yyvsp[0].powervar_type)->var, (yyvsp[0].powervar_type)->exp, &g_num_variables);
																		(yyval.term_type) = local_term_z;
																	}
																		...
																		if(g_coef_type == GMP_MPQ)
																			...
																			print_term_z((yyval.term_type), g_variables, g_num_variables, "term: $$: powerVariable");
																	#endif
